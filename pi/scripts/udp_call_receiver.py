#!/usr/bin/env python3
"""UDP Call Audio Receiver - receives call audio from MicStream and plays on HDMI."""
import socket
import subprocess
import sys
import os
...
SINK = 'alsa_output.platform-bcm2835_audio.digital-stereo'

print(f'UDP call audio receiver listening on port {PORT}')
